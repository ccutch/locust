...
},{"./cjs/react-dom.development.js":"../node_modules/react-dom/cjs/react-dom.development.js"}],"LocustApp.js":[function(require,module,exports) {
"use strict";
...
function (_React$PureComponent) {
  _inherits(LocustApp, _React$PureComponent);
  ...
  function LocustApp() {
    ...
    _classCallCheck(this, LocustApp);

    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(LocustApp)).call.apply(_getPrototypeOf2, [this].concat(args)));
    ...
    _defineProperty(_assertThisInitialized(_this), "_swarm", function () {
      ...
      fetch("/request?target=".concat(encodeURI(target))).then(function (res) {
        return res.text();
      }).then(_this._pollResults);
    });

    _defineProperty(_assertThisInitialized(_this), "_pollResults", function (requestID) {
      fetch("/results?requestID=".concat(requestID)).then(function (response) {
        var text = "";
        ...
        var appendChunks = function appendChunks(result) {
  ...
  _createClass(LocustApp, [{
    key: "render",
    value: function render() {
      var _this2 = this;

      return _react.default.createElement("div", null, _react.default.createElement("h3", null, "Where we droppin fam?"), _react.default.createElement("input", {
        ...
        onClick: this._swarm
      }, "Let's Get that Bread"), _react.default.createElement("hr", null), Object.keys(this.state.results).map(function (key) {
        return _react.default.createElement("div", null, _react.default.createElement("b", null, key, ":"), _react.default.createElement("span", null, _this2.state.results[key]));
      }));
    }
  }]);
...
(0, _reactDom.render)(_react.default.createElement(LocustApp), document.getElementById("main"));
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","LocustApp.js"], null)
